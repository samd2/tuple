...
def main(ctx):
  ...
  osx_cxx("TOOLSET=clang COMPILER=clang++ CXXSTD=03,11,1 Job 7", "clang++", packages="", buildtype="boost", environment={'TOOLSET': 'clang', 'COMPILER': 'clang++', 'CXXSTD': '03,11,14,1z', 'DRONE_JOB_OS_NAME': 'osx', 'DRONE_JOB_UUID': '902ba3cda1'}, globalenv=globalenv),
  ]
